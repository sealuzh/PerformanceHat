...
public class Ids {
  ...
  public static final String MICROSERVICE_ENDPOINT_ANNOTATION_IDENTIFIER = "eu.cloudwave.wp5.monitoring.annotations." + MICROSERVICE_ENDPOINT_ANNOTATION;
  ...
  public static final String MICROSERVICE_CLIENT_REQUEST_ANNOTATION_TO_METHOD_ATTRIBUTE = "calleeMethod";

  public static final String MICROSERVICE_ENDPOINT_ANNOTATION_IDENTIFIER_ATTRIBUTE = "identifier";
  public static final String MICROSERVICE_DECLARATION_ANNOTATION_METHOD_ATTRIBUTE = "method";

  public static final String MICROSERVICE_CLIENT_REQUEST_ANNOTATION_ATTRIBUTE_DEFAULT = "Unknown";
  public static final String MICROSERVICE_CLIENT_REQUEST_ANNOTATION_METHOD_ATTRIBUTE_DEFAULT = "/";
}
