...
/**
 * Annotating a method with this interface indicates that this method is used as a client to send requests to another
 * service. <br />
 * <b>Important</b>: the name of the annotation has to be equal to {@link Ids#MICROSERVICE_CLIENT_REQUEST_ANNOTATION}
 */
...
public @interface MicroserviceClientMethodDeclaration {
  ...
  /**
   * Microservice method of the callee<br />
   * <br />
   * Important: the name of the attribute (= 'calleeMethod') has to be equal to
   * {@link Ids#MICROSERVICE_CLIENT_REQUEST_ANNOTATION_TO_METHOD_ATTRIBUTE}
   * 
   * @return
   */
  public String calleeMethod() default Ids.MICROSERVICE_CLIENT_REQUEST_ANNOTATION_METHOD_ATTRIBUTE_DEFAULT;
}
