...
public class SampleView extends ViewPart {
   ...
   */
  public static final String ID = "cwfeedbackeclipse.views.SampleView";
  ...
  public void createPartControl(final Composite parent) {
    ...
    PlatformUI.getWorkbench().getHelpSystem().setHelp(viewer.getControl(), "cw-feedback-eclipse.viewer");
    makeActions();
    hookContextMenu();
