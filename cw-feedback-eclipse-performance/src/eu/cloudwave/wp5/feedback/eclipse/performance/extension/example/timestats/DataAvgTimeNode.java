...
public class DataAvgTimeNode implements AvgTimeNode{

	private final String text;
	private final double avgTime;
	private final Collection<AvgTimeNode> childs;
	
	public DataAvgTimeNode(String text, double avgTime, Collection<AvgTimeNode> childs) {
		this.text = text;
		this.avgTime = avgTime;
		this.childs = childs;
	}
	
	public DataAvgTimeNode(String text, double avgTime, AvgTimeNode... childs) {
